...
public class ModifyUserDialog extends javax.swing.JDialog {
     ...
     * @param msg
     */
    public ModifyUserDialog(MainFrame mainFrame, boolean modal, String companyCode, Connection conn, String msg) {
    ...
    private void initComponents() {
        ...
        headerTitle.setText("Modify User");
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(14, 14, 14)
                                .addComponent(userCodeCB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Button.light")), "User Type", 0, 0, new java.awt.Font("Trebuchet MS", 0, 12))); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Button.light")), "User Rights", 0, 0, new java.awt.Font("Trebuchet MS", 0, 12))); // NOI18N
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (validateUserInput()) {
            if (new SettingHandler().deleteUserCode(userCodeCB.getSelectedItem().toString(), this, companyCode, conn)) {
                if (new SettingHandler().updateUserInfo(this, companyCode, conn)) {
    ...
    private void userCodeCBPopupMenuWillBecomeInvisible(javax.swing.event.PopupMenuEvent evt) {//GEN-FIRST:event_userCodeCBPopupMenuWillBecomeInvisible
        if (userCodeCB.getSelectedIndex() > -1) {
            new SettingHandler().fetUserCodeRelatedData(userCodeCB.getSelectedItem().toString(), this, companyCode, conn);
        }
    ...
    public String getUserCode() {
        return userCodeCB.getSelectedItem().toString();
    }
    ...
    public void setUserType(String string) {
        if (string.equalsIgnoreCase("Admin")) {
            ...
            standardUserCB.setSelected(true);
        }
    }

    public void setUserRights(String string) {
        if (string.equalsIgnoreCase("All")) {
            setRigths(true);
        } else {
            if (string.contains("@Save")) {
                saveCHB.setSelected(true);
            } else {
                saveCHB.setSelected(false);
            }
            if (string.contains("@Update")) {
                updateCHB.setSelected(true);
            } else {
                updateCHB.setSelected(false);
            }
            if (string.contains("@Delete")) {
                deleteCHB.setSelected(true);
            } else {
                deleteCHB.setSelected(false);
            }
            if (string.contains("@Print")) {
                printCHB.setSelected(true);
            } else {
                printCHB.setSelected(false);
            }
        }
    }

    public void setFeatureForUser(String string) {
        if (string.equalsIgnoreCase("All")) {
            softwareFeaturesMake(true);
        } else {
            for(int i = 0; i<44; i++) {
                JCheckBox box = (JCheckBox) accNoList.getComponent(i);
                if(string.contains("@"+box.getText())) {
