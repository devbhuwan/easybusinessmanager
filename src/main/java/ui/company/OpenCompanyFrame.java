 ...
 * @author Bhuwan
 */
public class OpenCompanyFrame extends javax.swing.JDialog {
     ...
     * @param welcomeFrame
     */
    public OpenCompanyFrame(MainFrame parent, boolean modal, WelcomeFrame welcomeFrame) {
        super(parent, modal);
        mainFrame = parent;
        initComponents();
        fetchTable();
    ...
    private void openLogin(String companyCode) {
        login = new Login(mainFrame, true, companyCode, welcomeFrame);
        this.dispose();
