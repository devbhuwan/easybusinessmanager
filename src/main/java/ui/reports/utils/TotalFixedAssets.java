...
public class TotalFixedAssets {
     ...
     * @param cal1
     */
    public TotalFixedAssets(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row,int col) {
    ...
    private void doInBackground() {
        ...
        fixedAssets = fixedAssets + totJournalOnlyAmount.run();
        if (totJournalOnlyAmount.isFinished()) {
            firstReportTable.setValueAt(fixedAssets, row, col);
        }
    }
}
