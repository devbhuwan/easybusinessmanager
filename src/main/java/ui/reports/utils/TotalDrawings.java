...
public class TotalDrawings {
     ...
     * @param cal1
     */
    public TotalDrawings(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
