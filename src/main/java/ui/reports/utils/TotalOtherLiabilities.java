 ...
 */
public class TotalOtherLiabilities {
     ...
     * @param cal1
     */
    public TotalOtherLiabilities(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1, int row, int col) {
    ...
    private void doInBackground() {
        ...
        forGroups.add("Current Liabilities");
