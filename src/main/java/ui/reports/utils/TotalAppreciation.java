 ...
 */
public class TotalAppreciation {
     ...
     * @param col
     */
    public TotalAppreciation(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
