 ...
 */
public class TotalProvisionExpensesPay {
     ...
     * @param cal1
     */
    public TotalProvisionExpensesPay(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
