...
public class AccPayableAmount {
    ...
    public AccPayableAmount(MainFrame mainFrame, String companyCode, Calendar cal, Calendar cal1) {
    ...
    private double doInBackground() {
        ...
        //adding
        amountPayable = amountPayable + getFromSaleRegister();
        amountPayable = amountPayable + getFromPurchaseReturn();
        amountPayable = amountPayable + getFromSaleReturn();
        amountPayable = amountPayable + getFromPurchaseRegister();
        amountPayable = amountPayable - getFromPaymentVoucher();
        System.out.println("Account Payable : " + amountPayable);
        isFinished = true;
        return Math.abs(amountPayable);
    }
