 ...
 * @author Vimal
 */
public class TotalLoanRepaymenPaid {
     ...
     * @param col
     */
    public TotalLoanRepaymenPaid(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1, int row, int col) {
