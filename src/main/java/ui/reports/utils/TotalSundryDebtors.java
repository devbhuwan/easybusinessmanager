 ...
 */
public class TotalSundryDebtors {
     ...
     * @param cal1
     */
    public TotalSundryDebtors(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
