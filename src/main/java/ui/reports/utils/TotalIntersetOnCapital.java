 ...
 */
public class TotalIntersetOnCapital {
     ...
     * @param cal1
     */
    public TotalIntersetOnCapital(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
