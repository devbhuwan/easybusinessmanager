 ...
 * @author Vimal
 */
public class TotalSaleOfFixedAssets {
     ...
     * @param col
     */
    public TotalSaleOfFixedAssets(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1, int row, int col) {
