 ...
 */
public class TotalDepreciation {
     ...
     * @param col
     */
    public TotalDepreciation(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
