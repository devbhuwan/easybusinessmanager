 ...
 * @author Vimal
 */
public class TotalSaleOfInvestment {
     ...
     * @param col
     */
    public TotalSaleOfInvestment(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1, int row, int col) {
