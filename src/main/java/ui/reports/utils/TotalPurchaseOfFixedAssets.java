 ...
 * @author Vimal
 */
public class TotalPurchaseOfFixedAssets {
    ...
    private JournalOnlyDebitAmount totJournalOnlyAmount;
     ...
     * @param col
     */
    public TotalPurchaseOfFixedAssets(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1, int row, int col) {
    ...
    private void doInBackground() {
        ...
        totJournalOnlyAmount = new JournalOnlyDebitAmount(mainFrame, companyCode, cal, cal1, forGroups);
