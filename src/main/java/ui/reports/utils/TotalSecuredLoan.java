...
public class TotalSecuredLoan {
     ...
     * @param cal1
     */
    public TotalSecuredLoan(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
