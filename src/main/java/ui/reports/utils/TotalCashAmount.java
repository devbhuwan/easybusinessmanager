...
public class TotalCashAmount {
     ...
     * @param col
     */
    public TotalCashAmount(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
