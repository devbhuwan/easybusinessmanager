 ...
 */
public class TotalUnsecuredLoan {
     ...
     * @param cal1
     */
    public TotalUnsecuredLoan(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
