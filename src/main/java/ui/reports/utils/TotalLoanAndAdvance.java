 ...
 */
public class TotalLoanAndAdvance {
     ...
     * @param cal1
     */
    public TotalLoanAndAdvance(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
