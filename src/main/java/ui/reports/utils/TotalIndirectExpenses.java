 ...
 */
public class TotalIndirectExpenses {
     ...
     * @param col
     */
    public TotalIndirectExpenses(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
