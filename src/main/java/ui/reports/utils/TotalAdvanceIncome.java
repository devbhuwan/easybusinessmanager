 ...
 */
public class TotalAdvanceIncome {
     ...
     * @param cal1
     */
    public TotalAdvanceIncome(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
