 ...
 */
public class JournalOnlyAmount {
    ...
    public JournalOnlyAmount(MainFrame mainFrame, String companyCode, Calendar cal, Calendar cal1, ArrayList<String> forGroup) {
    ...
    private double doInBackground() {
        ...
        System.out.println("###" + forGroup + "###");
        System.out.println("Plus : " + amountPlusSide);
        amountMinusSide = amountMinusSide + getFromJournalVoucherCredit();
        System.out.println("Minus : " + amountMinusSide);
        isFinished = true;
        return Math.abs(amountPlusSide - amountMinusSide);
    }
