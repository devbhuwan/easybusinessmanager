 ...
 */
public class TotalCashFlowLoan {
     ...
     * @param col
     */
    public TotalCashFlowLoan(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
