 ...
 */
public class TotalProvisionAndDoubt {
     ...
     * @param cal1
     */
    public TotalProvisionAndDoubt(MainFrame mainFrame, String companyCode, JTable firstReportTable, Calendar cal, Calendar cal1,int row, int col) {
