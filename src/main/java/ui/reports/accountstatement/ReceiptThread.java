...
public class ReceiptThread {
    ...
    public ReceiptThread(MainFrame mainFrame, JTable reportTable, ArrayList<String> selectedAccNo, String companyCode) {
    ...
    private void doInBackgroundProcess(Calendar cal, Calendar cal1) {
        ...
        String sql = "select * from RECEIPT_VOUCHER_DETAIL where companyCode = ? AND (dateForVoucher BETWEEN " + fromDate + " AND " + toDate + ") ORDER by dateForVoucher desc";
        try {
    ...
    private void checkAccounts(String vN, String date) {
        ...
        try {
            ...
            while (r.next()) {
                ...
                String acND = new FetchVoucherData().getAccountName(aND, companyCode, mainFrame.getConnection3());
                String amountD = r.getString("debitAmount");
                String aNC = r.getString("creditAccountNumber");
                String acNC = new FetchVoucherData().getAccountName(aNC, companyCode, mainFrame.getConnection3());
