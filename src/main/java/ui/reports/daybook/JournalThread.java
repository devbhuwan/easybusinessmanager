...
public class JournalThread {
    ...
    public JournalThread(MainFrame mainFrame, JTable reportTable, String companyCode) {
    ...
    private void doInBackgroundProcess(Calendar cal) {
        ...
        String sql = "select * from JOURNAL_VOUCHER_DETAIL where companyCode = ? AND (dateForVoucher BETWEEN " + fromDate + " AND " + toDate + ")";
        try {
