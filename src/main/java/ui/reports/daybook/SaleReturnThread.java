...
public class SaleReturnThread {
    ...
    public SaleReturnThread(MainFrame mainFrame, JTable reportTable, String companyCode) {
    ...
    private void doInBackgroundProcess(Calendar cal) {
        ...
        String sql = "select * from SALE_RETURN_DETAIL where companyCode = ? AND (dateForVoucher BETWEEN " + fromDate + " AND " + toDate + ")";
        try {
