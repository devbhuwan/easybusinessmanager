...
public class ProductionThread {
    ...
    public ProductionThread(MainFrame mainFrame, JTable reportTable, String companyCode) {
    ...
    private void doInBackgroundProcess(Calendar cal) {
        ...
        String sql = "select * from PRODUCTION_VOUCHER_DETAIL where companyCode = ? AND (dateForVoucher BETWEEN " + fromDate + " AND " + toDate + ")";
        try {
