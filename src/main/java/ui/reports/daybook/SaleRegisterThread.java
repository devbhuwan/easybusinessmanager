...
public class SaleRegisterThread {
    ...
    public SaleRegisterThread(MainFrame mainFrame, JTable reportTable, String companyCode) {
    ...
    private void doInBackgroundProcess(Calendar cal) {
        ...
        String sql = "select * from SALE_REGISTER_DETAIL where companyCode = ? AND (dateForVoucher BETWEEN " + fromDate + " AND " + toDate + ")";
        try {
