 ...
 * @author Vimal
 */
public class SaleRegisterSaleRepotThread {
     ...
     * @param cal1
     */
    public SaleRegisterSaleRepotThread(MainFrame mainFrame, JTable reportTable, ArrayList<String> selectedAccNo, String companyCode, Calendar cal, Calendar cal1) {
