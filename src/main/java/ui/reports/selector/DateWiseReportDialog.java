...
import ui.reports.finalr.CashFlowReport;
 ...
 */
public class DateWiseReportDialog extends javax.swing.JDialog {
    ...
    private CashFlowReport cashFlowStatement;
     ...
     * @param msg
     */
    public DateWiseReportDialog(MainFrame mainFrame, boolean modal, String companyCode, String msg) {
    ...
    private void initComponents() {
        ...
        dateChooserCombo2.addCursorMoveListener(new datechooser.events.CursorMoveListener() {
            public void onCursorMove(datechooser.events.CursorMoveEvent evt) {
                dateChooserCombo2OnCursorMove(evt);
            }
        });
    ...
    private void showReport(Calendar c, Calendar c1) {
        errorMessage.setText(null);
        switch (msg) {
            case "Trial Balance":
                trialBalanceceReport = new TrialBalanceReport(mainFrame, companyCode, this);
                trialBalanceceReport.setDates(c, c1);
                trialBalanceceReport.setLocationRelativeTo(mainFrame);
                this.setVisible(false);
                trialBalanceceReport.setVisible(true);
                trialBalanceceReport.fetchInfo();
                break;
            case "Trading Account Report":
                tradingAccountReport = new TradingAccountReport(mainFrame, companyCode, this);
                tradingAccountReport.setDates(c, c1);
                tradingAccountReport.setLocationRelativeTo(mainFrame);
                this.setVisible(false);
                tradingAccountReport.setVisible(true);
                tradingAccountReport.fetchInfo();
                break;
            case "Profit and Loss Report":
                profitAndLossReport = new ProfitAndLossReport(mainFrame, companyCode, this);
                profitAndLossReport.setDates(c, c1);
                profitAndLossReport.setLocationRelativeTo(mainFrame);
                this.setVisible(false);
                profitAndLossReport.setVisible(true);
                profitAndLossReport.fetchInfo();
                break;
            case "Balance Sheet Report":
                balanceSheetReport = new BalanceSheetReport(mainFrame, companyCode, this);
                balanceSheetReport.setDates(c, c1);
                balanceSheetReport.setLocationRelativeTo(mainFrame);
                this.setVisible(false);
                balanceSheetReport.setVisible(true);
                balanceSheetReport.fetchInfo();
                break;
            case "Cash Flow Statement":
                cashFlowStatement = new CashFlowReport(mainFrame, companyCode, this);
                cashFlowStatement.setDates(c, c1);
                cashFlowStatement.setLocationRelativeTo(mainFrame);
                this.setVisible(false);
                cashFlowStatement.setVisible(true);
                cashFlowStatement.fetchInfo();
                break;
        }
    }
}
