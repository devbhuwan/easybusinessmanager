...
import ui.reports.print.SaleReportNotesTaker;
import ui.reports.print.action.AccountWiseReport1Print;
import ui.reports.sale.SaleReportUtils;
 ...
 * @author Vimal
 */
public class SalesReport extends javax.swing.JFrame implements TableModelListener {
    ...
    private SaleReportUtils jru;
    private SaleReportNotesTaker notesTaker;
     ...
     * @param dialog
     */
    public SalesReport(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new SaleReportNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new SaleReportUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                ...
                if (optionPane == 1) {
                    this.notes = notes;
                    print = new AccountWiseReport1Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName, "SALE REPORT");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                }
