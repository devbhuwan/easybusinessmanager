...
import ui.reports.debitnote.DebitNoteReportUtils;
import ui.reports.print.DebitNotesTaker;
 ...
 * @author Vimal
 */
public class DebitNoteReport extends javax.swing.JFrame implements TableModelListener {
    ...
    private DebitNoteReportUtils jru;
    private String notes;
    private AccountWiseReport1Print print;
    private DebitNotesTaker notesTaker;
     ...
     * @param dialog
     */
    public DebitNoteReport(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new DebitNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new DebitNoteReportUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                ...
                if (optionPane == 1) {
                    this.notes = notes;
                    print = new AccountWiseReport1Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName, "DEBIT NOTE");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                }
