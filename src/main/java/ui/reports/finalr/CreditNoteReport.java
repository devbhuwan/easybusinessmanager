...
import ui.reports.creditnote.CreditNoteReportUtils;
import ui.reports.print.CreditNotesTaker;
import ui.reports.print.action.AccountWiseReport1Print;
 ...
 * @author Vimal
 */
public class CreditNoteReport extends javax.swing.JFrame implements TableModelListener {
    ...
    private CreditNoteReportUtils jru;
    private CreditNotesTaker notesTaker;
    private AccountWiseReport1Print print;
     ...
     * @param dialog
     */
    public CreditNoteReport(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Credit Note Report");
        ...
        firstReportTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "S. N.", "Date", "Voucher Number ", "Account Number", "Account Name", "Debit Amount", "Credit Amount", "Remarks"
            }
        ) {
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new CreditNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new CreditNoteReportUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                int optionPane = JOptionPane.showConfirmDialog(mainFrame, "Warning", "Do you want override the file ?", JOptionPane.WARNING_MESSAGE);
                if (optionPane == 1) {
                    this.notes = notes;
                    print = new AccountWiseReport1Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName,"CREDIT NOTE");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                }
