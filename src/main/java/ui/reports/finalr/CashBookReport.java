...
import ui.reports.cashbook.CashBookUtils;
import ui.reports.print.CashNotesTaker;
 ...
 * @author Vimal
 */
public class CashBookReport extends javax.swing.JFrame implements TableModelListener {
    ...
    private CashBookUtils jru;
    private AccountWiseReport2Print print;
    private CashNotesTaker notesTaker;
     ...
     * @param dialog
     */
    public CashBookReport(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new CashNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new CashBookUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    private void setFirstTableTotalValues() {
        ...
        firstReportTable.setValueAt("CASH BALANCE", firstReportTable.getRowCount() - 1, 5);
     ...
     public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                ...
                if (optionPane == 0) {
                    this.notes = notes;
                    print = new AccountWiseReport2Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName, "CASH BOOK");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                } else {
