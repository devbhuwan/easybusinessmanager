...
import ui.reports.print.PurchaseReportNotesTaker;
import ui.reports.print.action.AccountWiseReport1Print;
import ui.reports.purchase.PurchaseReportUtils;
 ...
 * @author Vimal
 */
public class PurchaseReport extends javax.swing.JFrame implements TableModelListener {
    ...
    private PurchaseReportUtils jru;
    private String notes;
    private AccountWiseReport1Print print;
    private PurchaseReportNotesTaker notesTaker;
     ...
     * @param dialog
     */
    public PurchaseReport(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new PurchaseReportNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new PurchaseReportUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                ...
                if (optionPane == 1) {
                    this.notes = notes;
                    print = new AccountWiseReport1Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName, "PRUCHASE REPORT");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                }
