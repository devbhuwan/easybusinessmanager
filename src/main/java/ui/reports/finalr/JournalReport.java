...
import ui.reports.journal.JournalReportUtils;
import ui.reports.print.JournalNotesTaker;
 ...
 * @author Vimal
 */
public class JournalReport extends javax.swing.JFrame implements TableModelListener {
    ...
    private JournalReportUtils jru;
    private AccountWiseReport2Print print;
    private String notes;
    private JournalNotesTaker notesTaker;
     ...
     * @param dialog
     */
    public JournalReport(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Journal Report");
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new JournalNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new JournalReportUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                ...
                if (optionPane == 0) {
                    this.notes = notes;
                    print = new AccountWiseReport2Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName, "JOURNAL REPORT");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                } else {
