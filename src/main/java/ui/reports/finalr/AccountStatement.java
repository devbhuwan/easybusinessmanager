...
import ui.reports.print.AccountNotesTaker;
 ...
 * @author Vimal
 */
public class AccountStatement extends javax.swing.JFrame implements TableModelListener {
    ...
    private AccountStatementUtils jru;
    private AccountWiseReport2Print print;
    private String notes;
    private AccountNotesTaker notesTaker;
     ...
     * @param dialog
     */
    public AccountStatement(MainFrame mainFrame, String companyCode, AccountWiseReportDialog dialog) {
        initComponents();
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        if (firstReportTable.getRowCount() > 2) {
            notesTaker = new AccountNotesTaker(this, true);
    ...
    public void fetchInfo(ArrayList<String> selectedAccNo) {
        ...
        new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                jru = new AccountStatementUtils(mainFrame, cal, cal1, firstReportTable, accNo, companyCode);
                jru.run();
    ...
    public void printTable(String notes, String reportName) {
        ...
        if (Files.exists(path)) {
            if (Files.exists(pathForReport)) {
                ...
                if (optionPane == 0) {
                    this.notes = notes;
                    print = new AccountWiseReport2Print(mainFrame, companyCode, firstReportTable, notes, cal, cal1, reportName, "ACCOUNT STATEMENT");
                    print.prepare();
                    print.print();
                    notesTaker.dispose();
                } else {
