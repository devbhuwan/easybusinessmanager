 ...
 * @author Vimal
 */
public class AccountWiseReport2Print {
     ...
     * @param reportTitle
     */
    public AccountWiseReport2Print(MainFrame mainFrame, String companyCode, JTable reportTable, String notes, Calendar cal, Calendar cal1, String reportTitle,String transactionName) {
    ...
    public boolean print() {
        ...
        try {
            ...
            Logger.getLogger(AccountWiseReport2Print.class.getName()).log(Level.SEVERE, null, ex);
        }
        return status;
    }
