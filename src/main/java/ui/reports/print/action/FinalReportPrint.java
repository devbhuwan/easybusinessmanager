...
import ui.reports.print.model.FinalReportModel;

/**
 *
 * @author Vimal
 */
public class FinalReportPrint {
    ...
    private ArrayList<FinalReportModel> arrayList;
     ...
     * @param reportTitle
     */
    public FinalReportPrint(MainFrame mainFrame, String companyCode, JTable reportTable, String notes, Calendar cal, Calendar cal1, String reportTitle,String transactionName) {
    ...
    public boolean print() {
        ...
        try {
            JasperReport jr = JasperCompileManager.compileReport(new ReportFileGetter().getFilePath("FinalReportTemplate.jrxml"));
            ...
            Logger.getLogger(FinalReportPrint.class.getName()).log(Level.SEVERE, null, ex);
        }
        return status;
    }
    ...
    private void prepareModel() {
        ...
        for (int i = 0; i < reportTable.getRowCount(); i++) {
            arrayList.add(new FinalReportModel(reportTable.getValueAt(i, 0), reportTable.getValueAt(i, 1),
                    reportTable.getValueAt(i, 2), reportTable.getValueAt(i, 3),
                    reportTable.getValueAt(i, 4), reportTable.getValueAt(i, 5)));
        }
