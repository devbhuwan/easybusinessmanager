...
import ui.reports.print.model.AccountWiseReportModel1;
 ...
 * @author Vimal
 */
public class AccountWiseReport1Print {
    ...
    private ArrayList<AccountWiseReportModel1> arrayList;
     ...
     * @param reportTitle
     */
    public AccountWiseReport1Print(MainFrame mainFrame, String companyCode, JTable reportTable, String notes, Calendar cal, Calendar cal1, String reportTitle,String transactionName) {
    ...
    public boolean print() {
        ...
        try {
            JasperReport jr = JasperCompileManager.compileReport(new ReportFileGetter().getFilePath("AccountWiseReport2Template.jrxml"));
            ...
            Logger.getLogger(AccountWiseReport1Print.class.getName()).log(Level.SEVERE, null, ex);
        }
        return status;
    }
    ...
    private void prepareModel() {
        ...
        System.out.println(reportTable.getValueAt(0, 7));
        for (int i = 0; i < reportTable.getRowCount(); i++) {
            arrayList.add(new AccountWiseReportModel1(reportTable.getValueAt(i, 0), reportTable.getValueAt(i, 1),
                    reportTable.getValueAt(i, 2), reportTable.getValueAt(i, 3),
                    reportTable.getValueAt(i, 4), reportTable.getValueAt(i, 5), reportTable.getValueAt(i, 6),reportTable.getValueAt(i, 7)));
        }
