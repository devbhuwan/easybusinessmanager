...
import ui.reports.print.model.StockReportModel;

/**
 *
 * @author Vimal
 */
public class StockReportPrint {
    ...
    private ArrayList<StockReportModel> arrayList;
     ...
     * @param reportTitle
     */
    public StockReportPrint(MainFrame mainFrame, String companyCode, JTable reportTable, String notes, Calendar cal, Calendar cal1, String reportTitle,String transactionName) {
    ...
    public boolean print() {
        ...
        try {
            JasperReport jr = JasperCompileManager.compileReport(getClass().getResource("StockReportTemplate.jrxml").getPath());
            ...
            Logger.getLogger(StockReportPrint.class.getName()).log(Level.SEVERE, null, ex);
        }
        return status;
    }
    ...
    private void prepareModel() {
        ...
        for (int i = 0; i < reportTable.getRowCount(); i++) {
            arrayList.add(new StockReportModel(reportTable.getValueAt(i, 0), reportTable.getValueAt(i, 1),
