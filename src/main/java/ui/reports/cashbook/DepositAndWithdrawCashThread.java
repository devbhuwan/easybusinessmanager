 ...
 */
public class DepositAndWithdrawCashThread {
    ...
    public DepositAndWithdrawCashThread(MainFrame mainFrame, JTable reportTable, ArrayList<String> selectedAccNo, String companyCode) {
