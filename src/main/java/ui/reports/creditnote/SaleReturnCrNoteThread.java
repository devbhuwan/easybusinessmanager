 ...
 * @author Vimal
 */
public class SaleReturnCrNoteThread {
     ...
     * @param cal1
     */
    public SaleReturnCrNoteThread(MainFrame mainFrame, JTable reportTable, ArrayList<String> selectedAccNo, String companyCode, Calendar cal, Calendar cal1) {
    ...
    private void doInBackgrounProcess() {
        ...
        String sql = "SELECT * from SALE_RETURN_DETAIL where companyCode = ? AND (dateForVoucher BETWEEN " + fromDate + " AND " + toDate + ") ORDER BY dateForVoucher asc";
        try {
