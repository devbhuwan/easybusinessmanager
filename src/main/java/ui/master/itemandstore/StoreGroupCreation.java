 ...
 */
public class StoreGroupCreation extends javax.swing.JPanel {
     ...
     * @param conn
     */
    public StoreGroupCreation(String companyCode, Connection conn) {
        initComponents();
        ...
        storeGroupListTable.setTableHeader(new TableUI().getTableHeaderUI(storeGroupListTable));
    ...
    private void initComponents() {
        ...
        storeGroupListTable = new javax.swing.JTable();
        ...
        storeGroupListTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "S.N.", "Store Group Name"
            }
        ) {
        ...
        storeGroupListTable.setFocusable(false);
        storeGroupListTable.setRowHeight(23);
        storeGroupListTable.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        storeGroupListTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                storeGroupListTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(storeGroupListTable);
        if (storeGroupListTable.getColumnModel().getColumnCount() > 0) {
            storeGroupListTable.getColumnModel().getColumn(0).setPreferredWidth(150);
            storeGroupListTable.getColumnModel().getColumn(1).setPreferredWidth(800);
        }
        ...
        jLayeredPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Button.background")), "Store Group Details"));
        ...
        jLayeredPane1Layout.setHorizontalGroup(
            ...
            .addGroup(jLayeredPane1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jLayeredPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(groupNameTF, javax.swing.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE)
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (validateUserInput()) {
            if (new ItemAndStoreHandler().checkStoreGroupIsValidOrNot(companyCode, groupNameTF.getText(), conn)) {
                if (new ItemAndStoreHandler().saveStoreGroupInformation(companyCode, this, conn)) {
                    this.enableAllField(false);
                    this.saveOrUpdateControlShow();
                }
            } else {
                errorMessage.setOpaque(true);
                errorMessage.setText("Store group name is already exist.");
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        if (validateUserInput()) {
            if (groupNameTF.getText().equals(String.valueOf(groupName))) {
                if (new ItemAndStoreHandler().updateStoreGroupInformation(companyCode, this, groupName, conn)) {
                    this.enableAllField(false);
                    this.saveOrUpdateControlShow();
                }
            } else {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (new ItemAndStoreHandler().deleteStoreGroup(companyCode, groupNameTF.getText(), conn)) {
            this.clearAllField();
            this.enableAllField(false);
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
         try {
            ...
            MessageFormat headerFormat = new MessageFormat("List Of Store Groups [ " + companyName + " ("+companyCode+") ]");
            MessageFormat footerFormat = new MessageFormat("                                               Authorised Signature");
            storeGroupListTable.print(JTable.PrintMode.FIT_WIDTH,headerFormat,footerFormat);
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (new ItemAndStoreHandler().fetchStoreGroupInformation(companyCode, storeGroupListTable, conn)) {
            this.add(list);
    ...
    private void storeGroupListTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_storeGroupListTableMouseClicked
        if (storeGroupListTable.getRowCount() > 0) {
            if (evt.getClickCount() > 1 && storeGroupListTable.getSelectedRow() > -1) {
                groupName = storeGroupListTable.getValueAt(storeGroupListTable.getSelectedRow(), 1).toString();
                if (new ItemAndStoreHandler().fetchDataOfStoreGroup(companyCode, groupName, this, conn)) {
                    list.setVisible(false);
                    contentPanel.setVisible(true);
                    listControl.setVisible(false);
                    mainControl.setVisible(true);
    ...
    }//GEN-LAST:event_storeGroupListTableMouseClicked
    ...
    private javax.swing.JTable storeGroupListTable;
    ...
    private boolean validateUserInput() {
        ...
        if (!groupNameTF.getText().isEmpty()) {
            ...
            errorMessage.setOpaque(true);
            errorMessage.setText("Store group name is required.");
            groupNameTF.requestFocusInWindow();
        }
        return status;
    }
