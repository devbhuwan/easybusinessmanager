...
import ui.reports.print.PurchaseRegisterNotesTaker;
import ui.reports.print.action.RegRetPrint;
import ui.voucher.FetchVoucherData;
import ui.voucher.ListOfData;
import ui.voucher.saleandpurchase.utils.PurchaseRegisterHandler;

/**
 *
 * @author Vimal
 */
public class PurchaseRegister extends javax.swing.JPanel {
    ...
    private PurchaseRegisterNotesTaker notesTaker;
     ...
     * @param conn
     */
    public PurchaseRegister(MainFrame mainFrame, String companyCode, Connection conn) {
        initComponents();
    ...
    private void initComponents() {
        ...
        contentPanelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, contentPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(itemTableScroll, javax.swing.GroupLayout.DEFAULT_SIZE, 156, Short.MAX_VALUE)
                .addGap(2, 2, 2)
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLayeredPane3, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (validateUserInput()) {
            if (new PurchaseRegisterHandler(mainFrame, this).checkVoucherNumberIsValidOrNot(companyCode, voucherNumberTF.getText(), conn)) {
                if (new PurchaseRegisterHandler(mainFrame, this).savePurchaseRegisterInfo(this, conn, companyCode)) {
                    if (new PurchaseRegisterHandler(mainFrame, this).saveItemOrderInfo(this, conn, companyCode, itemTable)) {
                        if (billSundryTable.getRowCount() > 1) {
                            if (new PurchaseRegisterHandler(mainFrame, this).saveBillSundryInfo(this, conn, companyCode, billSundryTable)) {
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        if (validateUserInput()) {
            if (voucherNumberTF.getText().equals(String.valueOf(voucherNumber))) {
                if (new PurchaseRegisterHandler(mainFrame, this).deleteVoucherNumber(companyCode, voucherNumber, conn)) {
                    if (new PurchaseRegisterHandler(mainFrame, this).savePurchaseRegisterInfo(this, conn, companyCode)) {
                        if (new PurchaseRegisterHandler(mainFrame, this).saveItemOrderInfo(this, conn, companyCode, itemTable)) {
                            if (billSundryTable.getRowCount() > 1) {
                                if (new PurchaseRegisterHandler(mainFrame, this).saveBillSundryInfo(this, conn, companyCode, billSundryTable)) {
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        if (new PurchaseRegisterHandler(mainFrame, this).fetchPurchaseRegisterInformation(companyCode, saleOrderListTable, conn)) {
            this.add(list);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        if (new PurchaseRegisterHandler(mainFrame, this).deleteVoucherNumber(companyCode, voucherNumberTF.getText(), conn)) {
            this.clearAllField();
            this.enableAllField(false);
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        notesTaker = new PurchaseRegisterNotesTaker(mainFrame, this, true);
    ...
    private void saleOrderListTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_saleOrderListTableMouseClicked
        if (saleOrderListTable.getRowCount() > 0) {
            if (evt.getClickCount() > 1 && saleOrderListTable.getSelectedRow() > -1) {
                ...
                if (new PurchaseRegisterHandler(mainFrame, this).fetchDataOfPurchaseRegister(companyCode, voucherNumber, this, conn)) {
                    if (new PurchaseRegisterHandler(mainFrame, this).fetchItemDetail(companyCode, voucherNumber, itemTable, this, conn)) {
                        if (new PurchaseRegisterHandler(mainFrame, this).fetchBillSundryDetail(companyCode, voucherNumber, billSundryTable, this, conn)) {
                            list.setVisible(false);
                            container.setVisible(true);
                            mainControl.setVisible(true);
                            this.remove(list);
    ...
    public void setVoucherNumber(String companyCode, Connection conn) {
        voucherNumberTF.setText(new FetchVoucherData().getNextPurchaseRegisterVoucherNo(companyCode, conn));
    }
    ...
    private void itemTableControl() {
        ...
        if (selectedRow > -1) {
            if (itemTable.getSelectedRow() == itemTable.getRowCount() - 1) {
                ...
                calculateAmount();
                if (itemTable.getModel().getValueAt(itemTable.getSelectedRow(), 1) != null) {
                    primaryUnit = new PurchaseRegisterHandler(mainFrame, this).getUnitName(itemTable.getModel().getValueAt(itemTable.getSelectedRow(), 1).toString(), companyCode, conn);
